...
block-beta
    columns 2
    block:MAC["48-bit MAC Address"]:2
    block:OUI["OUI<br/>(24 bits)"]:1
    block:NIC["NIC<br/>(24 bits)"]:1
end
block-beta
    columns 1
    block:FirstOctet["First Octet (8 bits)<br/>b7 b6 b5 b4 b3 b2 b1 b0"]:1
    block:LSB["LSB / I/G Bit"]:1
    block:Uni["0 = Unicast"]:1
    block:Multi["1 = Multicast"]:1
```
