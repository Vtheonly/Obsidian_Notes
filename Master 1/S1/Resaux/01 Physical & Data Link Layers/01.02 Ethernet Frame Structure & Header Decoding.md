...
block-beta
    columns 10
    block:DstMAC["Destination MAC Address<br/>(6 bytes)"]:3
    block:SrcMAC["Source MAC Address<br/>(6 bytes)"]:3
    block:Type["Type / Length<br/>(2 bytes)"]:1
    block:Payload["Payload Data<br/>(46–1500 bytes)"]:3
```
