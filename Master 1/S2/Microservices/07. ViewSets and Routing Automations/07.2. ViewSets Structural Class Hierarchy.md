...
```mermaid
graph TD
    APIView["rest_framework.views.APIView"] --> ViewSet["viewsets.ViewSet"]
    APIView --> GenericAPIView["generics.GenericAPIView"]
    
    GenericAPIView --> GenericViewSet["viewsets.GenericViewSet"]
    
    GenericViewSet -->|Inherits CRUD Mixins| ModelViewSet["viewsets.ModelViewSet"]
    GenericViewSet -->|Inherits Read-Only Mixins| ReadOnlyModelViewSet["viewsets.ReadOnlyModelViewSet"]
