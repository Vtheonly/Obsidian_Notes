...
The curriculum exists to explain the engineering behind the application described in [[09. Project Architecture/01. Final Technical Report|Final Technical Report — Real-Time AI Boxing Coach]].
...
## Technical Chapter Notes

Each chapter folder contains one authoritative chapter note. The chapter note is the complete study/reference note for that chapter; there is no separate summary/deep-dive duplicate.
