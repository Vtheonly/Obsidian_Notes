...
source_collections:
  ...
  - "TAMER 2"
original_paths:
  - "TAMER 2/Chapter 7 - Data Pipeline and Preprocessing/3. Data Sanitization and Filtering.md"
  - "TAMER 1/Chapter 4/4.2 Synthetic Data and Augmentation.md"
roles_in_master:
  - "canonical"
  - "supplement"
topic:
...
master_filename: "03_Data_Sanitization_and_Filtering.md"
...
> **Original file:** `TAMER 1/Chapter 4/4.2 Synthetic Data and Augmentation.md`  
> **Role in master vault:** supplement perspective from TAMER 1 — T1 supplement. Disambiguated from T1 4.2 LaTeX Grammar Constraints. Appended to T2 Ch 7.3 canonical (data sanitization + augmentation share scope).  
