...
source_collections:
  - "TAMER 2"
original_paths:
  - "TAMER 2/Chapter 9 - Training Infrastructure and Techniques/8. Debugging Training Issues.md"
roles_in_master:
  - "canonical"
topic: "debugging"
master_chapter: "100_Training_Infrastructure_and_Techniques"
master_filename: "08_Debugging_Training_Issues.md"
...
if torch.isnan(loss):
    print(f" NaN loss at step {step}, skipping update")
    optimizer.zero_grad()
    continue
```
...
def _profile_dataloader(loader, name=""):
    ...
    if elapsed > 2.0:
        print(f" Slow first batch - possible I/O bottleneck")
    return elapsed
```
