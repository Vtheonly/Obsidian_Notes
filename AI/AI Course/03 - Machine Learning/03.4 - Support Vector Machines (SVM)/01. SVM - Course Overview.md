# 01. SVM — Course Overview

> **Prerequisites:** [[02. Types of Learning]], [[01. Introduction to Regression]]
> **Connections:** [[02. Introduction and The Widest Street]] (next), [[06. The Kernel Trick]]

This note provides the high-level overview of Support Vector Machines: the fundamental idea (maximum-margin separation), linear separability, and a preview of the kernel trick. The mathematical details are in the subsequent notes.
