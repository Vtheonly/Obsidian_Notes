---
tags: [neetcode, greedy, two-pointers]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/valid-parenthesis-string/) for the full statement.
...
The key technique for this problem is **hash map counting points per diagonal**. The general approach:
...
hash map counting points per diagonal
