---
tags: [neetcode, binary-search, design]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/time-based-key-value-store/) for the full statement.
