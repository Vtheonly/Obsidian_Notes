...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/search-in-rotated-sorted-array/) for the full statement.
