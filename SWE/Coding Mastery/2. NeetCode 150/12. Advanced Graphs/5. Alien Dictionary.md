---
tags: [neetcode, graph, topological, hard]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/alien-dictionary/) for the full statement.
