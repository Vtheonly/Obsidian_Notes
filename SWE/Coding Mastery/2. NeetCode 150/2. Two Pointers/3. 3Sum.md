---
tags: [neetcode, two-pointers, sorting]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/3sum/) for the full statement.
