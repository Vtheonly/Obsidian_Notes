...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/minimum-interval-to-include-each-query/) for the full statement.
