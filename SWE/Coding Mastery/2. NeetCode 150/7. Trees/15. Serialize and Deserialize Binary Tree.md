...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/serialize-and-deserialize-binary-tree/) for the full statement.
...
The key technique for this problem is **BFS or DFS serialization**. The general approach:
