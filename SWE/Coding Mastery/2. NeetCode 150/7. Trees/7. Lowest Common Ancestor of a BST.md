...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) for the full statement.
...
The key technique for this problem is **modular arithmetic with overflow check**. The general approach:
...
modular arithmetic with overflow check
