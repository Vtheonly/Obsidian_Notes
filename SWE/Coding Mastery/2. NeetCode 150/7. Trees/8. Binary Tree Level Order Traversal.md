...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/binary-tree-level-order-traversal/) for the full statement.
