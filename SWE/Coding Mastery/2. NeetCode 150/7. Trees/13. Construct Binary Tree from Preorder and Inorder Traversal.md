...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) for the full statement.
...
The key technique for this problem is **BFS with word transformation**. The general approach:
