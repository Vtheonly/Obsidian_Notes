...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/count-good-nodes-in-binary-tree/) for the full statement.
...
The key technique for this problem is **interval DP: dp[l][r] = max over last burst**. The general approach:
...
interval DP: dp[l][r] = max over last burst
