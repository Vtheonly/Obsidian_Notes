---
tags: [neetcode, tree, bst, inorder]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) for the full statement.
...
The key technique for this problem is **subset sum DP**. The general approach:
