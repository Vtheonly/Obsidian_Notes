---
tags: [neetcode, graph, union-find]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/) for the full statement.
...
The key technique for this problem is **2D DP with regex matching (., *)**. The general approach:
