---
tags: [neetcode, graph, topological]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/course-schedule-ii/) for the full statement.
