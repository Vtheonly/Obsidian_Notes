...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) for the full statement.
...
The key technique for this problem is **DP tracking max and min product**. The general approach:
...
DP tracking max and min product
