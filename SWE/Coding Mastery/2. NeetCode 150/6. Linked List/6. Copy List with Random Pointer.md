---
tags: [neetcode, linked-list, hash-map]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/copy-list-with-random-pointer/) for the full statement.
