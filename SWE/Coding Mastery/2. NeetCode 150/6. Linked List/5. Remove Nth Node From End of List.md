---
tags: [neetcode, linked-list, two-pointers]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) for the full statement.
...
The key technique for this problem is **addition with carry**. The general approach:
