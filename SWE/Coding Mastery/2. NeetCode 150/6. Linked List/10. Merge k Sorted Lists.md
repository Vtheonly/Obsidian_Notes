---
tags: [neetcode, linked-list, heap]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/merge-k-sorted-lists/) for the full statement.
