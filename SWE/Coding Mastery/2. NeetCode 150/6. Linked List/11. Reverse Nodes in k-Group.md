---
tags: [neetcode, linked-list, hard]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/reverse-nodes-in-k-group/) for the full statement.
