---
tags: [neetcode, dp, state-machine]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) for the full statement.
...
The key technique for this problem is **DP: dp[i] = dp[i >> 1] + (i & 1)**. The general approach:
