...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/) for the full statement.
