---
tags: [neetcode, sliding-window, monotonic]
difficulty: varies
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/sliding-window-maximum/) for the full statement.
