...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/problems/kth-largest-element-in-a-stream/) for the full statement.
...
The key technique for this problem is **transpose + reverse rows**. The general approach:
