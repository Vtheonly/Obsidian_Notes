---
tags: [neetcode, math, binary-exponentiation]
difficulty: varies
url: https://leetcode.com/powx-n/
platform: LeetCode
...
This is a LeetCode problem from the NeetCode 150 roadmap. See the [official problem page](https://leetcode.com/powx-n/) for the full statement.
...
The key technique for this problem is **bit manipulation with carry**. The general approach:
