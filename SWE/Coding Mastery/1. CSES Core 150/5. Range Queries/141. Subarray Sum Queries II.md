...
# 141. Subarray Sum Queries II

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/3226) for the full statement.
...
The key technique for this problem is **segment tree with subarray sum**. The general approach:
...
segment tree with subarray sum
