...
# 136. Prefix Sum Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/2166) for the full statement.
...
The key technique for this problem is **segment tree storing prefix sum and min prefix sum**. The general approach:
...
segment tree storing prefix sum and min prefix sum
