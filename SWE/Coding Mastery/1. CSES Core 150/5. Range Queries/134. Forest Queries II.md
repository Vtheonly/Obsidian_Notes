...
# 134. Forest Queries II

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1739) for the full statement.
...
The key technique for this problem is **2D Fenwick tree**. The general approach:
