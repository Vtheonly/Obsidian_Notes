---
tags: [cses, range, binary-lifting]
difficulty: medium
...
# 129. Movie Festival Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1664) for the full statement.
...
The key technique for this problem is **binary lifting on intervals**. The general approach:
