...
# 127. Range Update Queries

## 1. Problem Description

This is a easy CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1651) for the full statement.
...
The key technique for this problem is **difference array / Fenwick tree for range updates**. The general approach:
...
difference array / Fenwick tree for range updates
