...
# 131. Range Updates and Sums

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1735) for the full statement.
...
The key technique for this problem is **lazy propagation segment tree**. The general approach:
