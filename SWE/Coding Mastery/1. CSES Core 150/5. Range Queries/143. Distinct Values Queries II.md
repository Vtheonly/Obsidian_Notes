...
# 143. Distinct Values Queries II

## 1. Problem Description

This is a hard CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/3356) for the full statement.
...
The key technique for this problem is **Mo's algorithm or persistent segment tree**. The general approach:
...
Mo's algorithm or persistent segment tree
