...
# 139. Increasing Array Queries

## 1. Problem Description

This is a hard CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/2416) for the full statement.
...
The key technique for this problem is **segment tree with monotonic stack**. The general approach:
...
segment tree with monotonic stack
