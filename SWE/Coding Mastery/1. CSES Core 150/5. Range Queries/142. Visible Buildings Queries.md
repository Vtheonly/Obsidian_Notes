...
# 142. Visible Buildings Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/3304) for the full statement.
...
The key technique for this problem is **segment tree for visible buildings**. The general approach:
...
segment tree for visible buildings
