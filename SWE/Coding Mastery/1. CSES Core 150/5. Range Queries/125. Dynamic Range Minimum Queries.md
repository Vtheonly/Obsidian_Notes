...
# 125. Dynamic Range Minimum Queries

## 1. Problem Description

This is a easy CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1649) for the full statement.
...
The key technique for this problem is **segment tree for range minimum**. The general approach:
