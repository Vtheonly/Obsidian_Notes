...
# 140. Range Interval Queries

## 1. Problem Description

This is a hard CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/3163) for the full statement.
...
The key technique for this problem is **offline processing with segment tree**. The general approach:
