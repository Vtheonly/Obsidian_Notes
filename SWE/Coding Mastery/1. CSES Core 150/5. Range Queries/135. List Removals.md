...
This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1749) for the full statement.
...
The key technique for this problem is **implicit segment tree or treap**. The general approach:
...
implicit segment tree or treap
