...
This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1144) for the full statement.
...
The key technique for this problem is **coordinate compression + Fenwick tree**. The general approach:
