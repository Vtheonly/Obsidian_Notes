...
This is a easy CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1652) for the full statement.
...
The key technique for this problem is **2D prefix sum**. The general approach:
