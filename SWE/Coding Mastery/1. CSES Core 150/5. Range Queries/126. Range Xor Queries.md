...
# 126. Range Xor Queries

## 1. Problem Description

This is a easy CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1650) for the full statement.
...
The key technique for this problem is **prefix XOR for range XOR queries**. The general approach:
