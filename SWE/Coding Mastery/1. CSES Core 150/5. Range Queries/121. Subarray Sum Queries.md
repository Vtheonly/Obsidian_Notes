...
# 121. Subarray Sum Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1190) for the full statement.
...
The key technique for this problem is **segment tree storing (sum, max_prefix, max_subarray, max_suffix)**. The general approach:
...
segment tree storing (sum, max_prefix, max_subarray, max_suffix)
