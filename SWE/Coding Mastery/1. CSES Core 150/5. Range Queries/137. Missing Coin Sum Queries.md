...
# 137. Missing Coin Sum Queries

## 1. Problem Description

This is a hard CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/2184) for the full statement.
...
The key technique for this problem is **segment tree with merge sort**. The general approach:
