---
tags: [cses, range, lazy-segment-tree]
difficulty: medium
...
# 132. Polynomial Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1736) for the full statement.
...
The key technique for this problem is **lazy segment tree with linear function updates**. The general approach:
...
lazy segment tree with linear function updates
