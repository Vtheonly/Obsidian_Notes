...
# 138. Pizzeria Queries

## 1. Problem Description

This is a medium CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/2206) for the full statement.
...
The key technique for this problem is **segment tree with convex hull trick**. The general approach:
...
segment tree with convex hull trick
