...
# 133. Range Queries and Copies

## 1. Problem Description

This is a hard CSES problem from the Range Queries section. See the [official problem page](https://cses.fi/problemset/task/1737) for the full statement.
...
The key technique for this problem is **persistent segment tree**. The general approach:
