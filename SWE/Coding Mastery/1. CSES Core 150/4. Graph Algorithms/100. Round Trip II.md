...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1678) for the full statement.
...
The key technique for this problem is **DFS cycle detection in directed graph**. The general approach:
