---
tags: [cses, graph, bipartite-matching]
difficulty: medium
...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1696) for the full statement.
...
The key technique for this problem is **Hopcroft-Karp bipartite matching**. The general approach:
