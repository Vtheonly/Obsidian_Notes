...
# 102. Longest Flight Route

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1680) for the full statement.
...
The key technique for this problem is **DP on DAG (longest path)**. The general approach:
