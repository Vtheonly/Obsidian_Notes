...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1196) for the full statement.
...
The key technique for this problem is **k-th shortest path using modified Dijkstra**. The general approach:
...
k-th shortest path using modified Dijkstra
