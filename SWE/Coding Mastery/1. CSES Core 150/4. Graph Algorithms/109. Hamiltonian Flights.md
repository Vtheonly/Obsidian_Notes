...
# 109. Hamiltonian Flights

## 1. Problem Description

This is a hard CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1690) for the full statement.
...
The key technique for this problem is **bitmask DP (Hamiltonian path counting)**. The general approach:
...
bitmask DP (Hamiltonian path counting)
