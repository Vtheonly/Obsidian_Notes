...
# 105. Planets and Kingdoms

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1683) for the full statement.
...
The key technique for this problem is **SCC to identify kingdoms**. The general approach:
