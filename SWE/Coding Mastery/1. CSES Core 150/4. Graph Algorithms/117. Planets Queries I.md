---
tags: [cses, graph, binary-lifting]
difficulty: medium
...
# 117. Planets Queries I

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1750) for the full statement.
...
The key technique for this problem is **binary lifting on functional graph**. The general approach:
