...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1195) for the full statement.
...
The key technique for this problem is **modified Dijkstra with state (node, has_used_discount)**. The general approach:
...
modified Dijkstra with state (node, has_used_discount)
