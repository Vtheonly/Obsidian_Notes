...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1673) for the full statement.
...
The key technique for this problem is **Bellman-Ford for longest path (negate weights)**. The general approach:
