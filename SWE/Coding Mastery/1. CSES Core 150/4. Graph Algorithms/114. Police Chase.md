...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1695) for the full statement.
...
The key technique for this problem is **minimum cut (max-flow min-cut theorem)**. The general approach:
