...
# 104. Flight Routes Check

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1682) for the full statement.
...
The key technique for this problem is **SCC (Kosaraju or Tarjan) for reachability**. The general approach:
...
SCC (Kosaraju or Tarjan) for reachability
