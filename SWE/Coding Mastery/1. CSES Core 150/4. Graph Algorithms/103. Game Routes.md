...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1681) for the full statement.
...
The key technique for this problem is **DP on DAG (path counting)**. The general approach:
