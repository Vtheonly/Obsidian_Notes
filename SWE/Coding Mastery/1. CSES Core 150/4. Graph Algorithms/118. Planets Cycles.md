---
tags: [cses, graph, functional-graph]
difficulty: medium
...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1751) for the full statement.
...
The key technique for this problem is **cycle detection in functional graph**. The general approach:
...
cycle detection in functional graph
