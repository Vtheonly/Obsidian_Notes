...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1197) for the full statement.
...
The key technique for this problem is **Bellman-Ford with parent tracking for cycle recovery**. The general approach:
...
Bellman-Ford with parent tracking for cycle recovery
