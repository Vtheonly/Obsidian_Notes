...
# 111. De Bruijn Sequence

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1692) for the full statement.
...
The key technique for this problem is **De Bruijn sequence via Eulerian circuit**. The general approach:
