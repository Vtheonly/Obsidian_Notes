...
This is a easy CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1669) for the full statement.
...
The key technique for this problem is **DFS cycle detection in undirected graph**. The general approach:
