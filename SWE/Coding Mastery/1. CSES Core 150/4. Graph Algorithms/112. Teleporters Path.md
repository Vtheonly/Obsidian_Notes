...
# 112. Teleporters Path

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1693) for the full statement.
...
The key technique for this problem is **Eulerian path in directed graph**. The general approach:
