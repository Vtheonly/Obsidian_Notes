...
# 99. Road Construction

## 1. Problem Description

This is a easy CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1676) for the full statement.
...
The key technique for this problem is **Union-Find to track component sizes**. The general approach:
...
Union-Find to track component sizes
