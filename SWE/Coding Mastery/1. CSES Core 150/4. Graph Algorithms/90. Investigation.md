...
This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1202) for the full statement.
...
The key technique for this problem is **Dijkstra with state counting (shortest paths, minimum cost, minimum flights, maximum flights)**. The general approach:
...
Dijkstra with state counting (shortest paths, minimum cost, minimum flights, maximum flights)
