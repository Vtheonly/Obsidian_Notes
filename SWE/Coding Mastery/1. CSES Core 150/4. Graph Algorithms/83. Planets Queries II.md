...
# 83. Planets Queries II

## 1. Problem Description

This is a medium CSES problem from the Graph Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1160) for the full statement.
...
The key technique for this problem is **binary lifting on functional graphs**. The general approach:
