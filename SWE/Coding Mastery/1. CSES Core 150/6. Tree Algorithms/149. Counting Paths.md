...
This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1136) for the full statement.
...
The key technique for this problem is **LCA + difference array on tree**. The general approach:
