...
# 154. Company Queries I

## 1. Problem Description

This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1687) for the full statement.
...
The key technique for this problem is **binary lifting**. The general approach:
