...
# 158. Fixed-Length Paths II

## 1. Problem Description

This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/2081) for the full statement.
...
The key technique for this problem is **centroid decomposition**. The general approach:
