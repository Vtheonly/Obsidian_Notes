...
# 156. Finding a Centroid

## 1. Problem Description

This is a easy CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/2079) for the full statement.
