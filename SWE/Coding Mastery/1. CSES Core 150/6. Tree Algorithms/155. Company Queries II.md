...
# 155. Company Queries II

## 1. Problem Description

This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1688) for the full statement.
...
The key technique for this problem is **binary lifting for LCA**. The general approach:
