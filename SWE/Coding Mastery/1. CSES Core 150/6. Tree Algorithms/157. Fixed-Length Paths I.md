...
# 157. Fixed-Length Paths I

## 1. Problem Description

This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/2080) for the full statement.
