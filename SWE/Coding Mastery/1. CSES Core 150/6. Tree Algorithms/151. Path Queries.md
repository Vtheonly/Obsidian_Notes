...
This is a medium CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1138) for the full statement.
...
The key technique for this problem is **Euler tour + Fenwick tree (path updates)**. The general approach:
...
Euler tour + Fenwick tree (path updates)
