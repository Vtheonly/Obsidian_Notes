...
This is a easy CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/1674) for the full statement.
...
The key technique for this problem is **DFS for subtree sizes**. The general approach:
