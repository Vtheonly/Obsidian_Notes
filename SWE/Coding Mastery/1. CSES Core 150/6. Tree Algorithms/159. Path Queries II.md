...
This is a hard CSES problem from the Tree Algorithms section. See the [official problem page](https://cses.fi/problemset/task/2134) for the full statement.
...
The key technique for this problem is **heavy-light decomposition**. The general approach:
