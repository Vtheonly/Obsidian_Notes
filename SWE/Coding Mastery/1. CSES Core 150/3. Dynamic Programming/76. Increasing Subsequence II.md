...
# 76. Increasing Subsequence II

## 1. Problem Description

This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/1748) for the full statement.
...
The key technique for this problem is **Fenwick tree for DP optimization**. The general approach:
...
Fenwick tree for DP optimization
