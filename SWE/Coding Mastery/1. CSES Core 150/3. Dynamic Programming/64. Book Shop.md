...
This is a easy CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/1158) for the full statement.
...
The key technique for this problem is **0/1 knapsack DP**. The general approach:
