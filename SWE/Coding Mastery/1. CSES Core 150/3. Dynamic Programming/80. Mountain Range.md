...
This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/3314) for the full statement.
...
The key technique for this problem is **DP on tree-like structures**. The general approach:
