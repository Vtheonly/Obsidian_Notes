---
tags: [cses, dp, weighted-interval]
difficulty: medium
...
This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/1140) for the full statement.
...
The key technique for this problem is **weighted interval scheduling with DP + coordinate compression**. The general approach:
...
weighted interval scheduling with DP + coordinate compression
