...
# 81. Minimal Grid Path

## 1. Problem Description

This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/3359) for the full statement.
...
The key technique for this problem is **greedy + DP hybrid**. The general approach:
