...
This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/2220) for the full statement.
...
The key technique for this problem is **digit DP**. The general approach:
