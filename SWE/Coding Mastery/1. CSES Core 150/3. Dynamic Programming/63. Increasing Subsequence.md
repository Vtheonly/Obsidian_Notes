...
# 63. Increasing Subsequence

## 1. Problem Description

This is a easy CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/1145) for the full statement.
...
The key technique for this problem is **patience sorting / binary search for LIS**. The general approach:
...
patience sorting / binary search for LIS
