...
This is a medium CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/2413) for the full statement.
...
The key technique for this problem is **DP with states for tower configurations**. The general approach:
...
DP with states for tower configurations
