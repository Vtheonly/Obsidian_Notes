...
This is a hard CSES problem from the Dynamic Programming section. See the [official problem page](https://cses.fi/problemset/task/1653) for the full statement.
...
The key technique for this problem is **bitmask DP with subset iteration**. The general approach:
...
bitmask DP with subset iteration
