...
Good database design enforces these integrity principles through table structure, constraints, and relationships. When the design is sound, the database itself prevents most types of data errors rather than relying on application logic to catch them after the fact. See [[7 - Data Integrity]] for a more detailed exploration of these concepts.
...
Understanding the design process leads naturally to a deeper exploration of data integrity, which is the primary objective of good design. See [[7 - Data Integrity]] for a comprehensive discussion of entity, referential, and domain integrity.
