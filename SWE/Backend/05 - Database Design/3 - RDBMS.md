...
With an understanding of what an RDBMS does, the next step is to learn about the language used to communicate with it. SQL is the standard language for defining database structures and manipulating the data within them. See [[4 - Introduction to SQL]] for a detailed introduction.
