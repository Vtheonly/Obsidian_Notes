...
This note builds on the concepts from [[28 - NOT NULL Foreign Key]] and [[42 - Inner Join]], focusing specifically on how the `NOT NULL` constraint changes the practical behavior of different join types.
