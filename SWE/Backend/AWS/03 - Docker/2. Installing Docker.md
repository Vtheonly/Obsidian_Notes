...
If you are on a modern version of Windows 10 or Windows 11, Docker Desktop often handles the prerequisites automatically. However, understanding the manual steps is vital for troubleshooting.
...
4.  **Launch Ubuntu:** Once installed, open it. It will ask you to create a Unix **username** and **password**.
    - This username/password is specific to Linux, it does not have to match your Windows login.
...
1.  **Containers:**
    ...
    - These are the active "houses" built from your blueprints.
2.  **Images:**
    ...
    - These are the "blueprints" or "installation disks" stored on your hard drive.
3.  **Volumes:**
...
Previous: [[1. What is Docker]] | Next: [[3. Images and Containers]]
