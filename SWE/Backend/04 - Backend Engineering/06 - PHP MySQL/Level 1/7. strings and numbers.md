---
tags: [PHP, Strings, Functions, StringManipulation, Numbers, Math, Operators, BIDMAS]
---

# PHP Strings and Numbers

PHP provides a rich library of built-in functions to manipulate strings and perform mathematical operations with numbers. These are core building blocks for almost any program.

See also: [[5. Index]], [[1. echo]]
