...
-   **Use `print_r()` exclusively for debugging.** It's your best friend when you need to see what's inside an array or object while you're developing. Never show its raw output to your end-users.
