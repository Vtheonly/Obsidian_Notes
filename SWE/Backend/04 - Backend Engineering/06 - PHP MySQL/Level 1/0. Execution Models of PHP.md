...
# Execution Models of PHP

PHP can operate under two fundamentally different execution models. Understanding this distinction is key to understanding the different environments in which PHP runs.
...
See also: [[0.1 Apache Server]], [[0.3 MariaDB VS MySQL]]
...
See also: [[0. Docker vs Apache]] (Production Mode Practices)
