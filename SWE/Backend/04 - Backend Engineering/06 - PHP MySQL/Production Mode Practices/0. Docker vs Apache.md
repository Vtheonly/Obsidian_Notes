---
tags: [PHP, Docker, Apache, Deployment, Production, Containerization, DockerCompose]
---

# Docker vs Apache

This is the core debate in modern web deployment: **Traditional ("Bare-Metal") vs. Containerized deployment.**

There is no single "right" answer, but there is a clear **modern standard** for professional work.

See also: [[0.1 Apache Server]], [[0. Execution Models of PHP]], [[8. Docker Compose]] (Docker section)
...
For a detailed guide on orchestrating multiple containers, see [[8. Docker Compose]] in the Docker section.
