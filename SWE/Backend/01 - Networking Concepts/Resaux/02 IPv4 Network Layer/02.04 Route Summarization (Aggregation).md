...
```mermaid
graph LR
    S10["192.168.10.0/24<br/>00001 010"] --> Match["Matching Bits: 5 bits<br/>Prefix: 16 + 5 = /21"]
    S11["192.168.11.0/24<br/>00001 011"] --> Match
    S12["192.168.12.0/24<br/>00001 100"] --> Match
    S13["192.168.13.0/24<br/>00001 101"] --> Match
    S14["192.168.14.0/24<br/>00001 110"] --> Match
    S15["192.168.15.0/24<br/>00001 111"] --> Match
    Match --> Summary["Summary Route: 192.168.8.0/21"]
```
