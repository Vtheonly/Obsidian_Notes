...
See also: [[6. Indexed Array]], [[7. strings and numbers]]
...
While you can **read** characters using bracket notation, you **cannot modify a string** by assigning a new character to an index. PHP will not produce an error, but it also won't change the original string.
