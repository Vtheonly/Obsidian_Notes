---
tags: [PHP, Errors, Debugging, ErrorHandling, php_ini, Development, ParseError, FatalError, Warning, Notice]
---

# PHP Error Handling: Understanding and Displaying Errors

One of the first hurdles in learning PHP is understanding how it handles errors. The behavior you see depends on the **type of error** and the **server's configuration**. This note explains why errors can seem inconsistent and categorizes the different types of errors you will encounter.
...
PHP errors can be broadly categorized by their severity, from most severe to least severe.
...
Think of PHP as a chef following a recipe (your script). The chef performs two main steps:
...
7  ?>
```
**Behavior:** You will get a `Parse error: syntax error...` message pointing to line 6. **Absolutely nothing will be printed to the screen.** The first four lines do not run.
...
## Summary Table: Error Impact on Execution
...
See also: [[3. Include and Require]] (Level 2), [[1. Functions]] (Level 2)
