...
See also: [[6. Indexed Array]], [[6.1 Associative Arrays]], [[6.3 htmlspecialchars]], [[8. Loops]]

---

## Creating and Visualizing Multi-Dimensional Arrays

A multi-dimensional array is an array where each element is another array. Let's use the example of a list of blog posts.
