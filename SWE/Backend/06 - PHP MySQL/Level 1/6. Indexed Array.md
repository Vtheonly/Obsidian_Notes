...
See also: [[6.1 Associative Arrays]], [[6.2 Multi-Dimensional Arrays]], [[6.3 htmlspecialchars]]
...
To get a single value out of the array, you use its name followed by the desired index inside square brackets `[]`.
...
See also: [[1.1 echo vs. print vs. print_r]]
