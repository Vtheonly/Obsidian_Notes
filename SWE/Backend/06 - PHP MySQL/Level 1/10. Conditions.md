...
See also: [[9. Boolean and Comparison]], [[8. Loops]], [[11. break and continue]]
...
Let's use the `$products` array to find items within a specific price range.
...
<?php
  ...
  // can NEVER be true. A number cannot be both greater
...
## 3. Alternative Syntax for Templating (Mixing HTML and PHP)
...
See also: [[2. Mixing PHP and HTML]], [[6.3 htmlspecialchars]]
