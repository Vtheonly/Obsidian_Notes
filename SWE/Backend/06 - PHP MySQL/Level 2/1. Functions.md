...
See also: [[2. Variable scope]], [[3. Include and Require]]
...
?>
```
> **Security Note:** Notice the use of `htmlspecialchars()` here. If `$name` were to come from user input, this would prevent XSS attacks. See also: [[6.3 htmlspecialchars]] (Level 1)
...
See also: [[2. Variable scope]] for a detailed treatment of this topic.
