...
Atomic values are a prerequisite for understanding relationships between entities, which is the next major topic in database design. See [[01 - Relationships Overview]] for an introduction to how entities connect to one another.
