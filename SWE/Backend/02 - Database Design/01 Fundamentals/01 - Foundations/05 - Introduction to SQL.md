...
With an understanding of how SQL is used to define and manipulate database structures, the next topic addresses how to name database objects consistently and clearly. See [[06 - Naming Conventions]] for best practices.
