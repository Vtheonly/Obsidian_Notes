...
Building on the table from [[09 - Database Terms]], additional synonyms include:
...
With the essential terminology established, the next topic explores the concept of atomic values, which is a foundational principle of database normalization. See [[11 - Atomic Values]] for a detailed explanation.
