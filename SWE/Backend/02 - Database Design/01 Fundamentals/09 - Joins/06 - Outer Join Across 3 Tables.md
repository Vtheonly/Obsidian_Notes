...
This note builds on the multi-table join concepts from [[04 - Inner Join on 3 Tables]] and the outer join fundamentals from [[05 - Outer Joins Explained]]. Understanding both of those topics is essential before tackling outer joins across three tables.
