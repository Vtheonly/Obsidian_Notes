...
For comparison with other relationship types, see [[01 - Relationships Overview]]. For one-to-many relationships, see the subsequent section on one-to-many relationships. For many-to-many relationships, see the subsequent section on many-to-many relationships.
